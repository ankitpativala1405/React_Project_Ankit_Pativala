...
import imbblack from '../assets/images/logo/actual-size/logo-ibm__black.svg'
import cardexpence from '../assets/images/card-expenses.png'
...
import archlinereverce from '../assets/images/arch-line-reverse.svg'
import googleblack from '../assets/images/logo/actual-size/logo-google__black.svg'
import airbnbblack from '../assets/images/logo/actual-size/logo-air-bnb__black.svg'
    ...
    <div>
      <div className="site-wrap">
          ...
          <div className="container d-flex align-items-center ~justify-content-between">
            <a className="navbar-brand w-auto" href="index.html">
              <img
                ...
                style={{ padding: "0", width: "104px", height: "38px" }}
              />
              <img
                    ...
                    <ul className="dropdown-menu">
                      ...
                      <li className="nav-item dropstart">
                        <a
                          ...
                          aria-expanded="false"
                        >
                          Dropstart <i className="bi bi-chevron-right" />
                        </a>
                        <ul className="dropdown-menu">
                          <li>
                            <a
                            ...
                            <ul className="dropdown-menu">
                              ...
                              <li className="nav-item dropend">
                                <a
                                  ...
                                  aria-expanded="false"
                                >
                                  Dropend <i className="bi bi-chevron-right" />
                                </a>
                                <ul className="dropdown-menu">
                                  <li>
                                    <a
        ...
        <main>
                            ...
                            <div className="h-100 flex-column justify-content-between d-flex">
                              ...
                              <div className="align-self-start">
                                <a
                                  ...
                                  data-gallery="video"
                                >
                                  <i className="bi bi-play-fill" /> Watch the Video
                                </a>
                              </div>
                            </div>
                          </div>
                            ...
                            <div className="row">
                              ...
                              >
                                <div className="icon text-center mb-4">
                                  <i className="bi bi-person-check fs-4" />
                                </div>
                              ...
                              >
                                <div className="icon text-center mb-4">
                                  <i className="bi bi-headset fs-4" />
                                </div>
                                <h3 className="fs-6 fw-bold mb-3">
                                  Customer Support
                                </h3>
                ...
                <div className="col-12">
                  ...
                  >
                    <div className="rounded-borders">
                      ...
                      <div className="rounded-border-3" />
                    </div>
                    <div
                  ...
                  <div className="service-card p-4 rounded-4 h-100 d-flex flex-column justify-content-between gap-5">
                    ...
                    >
                      <span className="icons">
                        <i className="icon-1 bi bi-arrow-right-short" />
            ...
            <div className="container">
              ...
              <div className="row g-4" data-masonry='{"percentPosition": true }'>
                ...
                >
                  <div className="testimonial rounded-4 p-4">
                    <blockquote className="mb-3">
                      ...
                      business finances. The real-time transaction tracking and
                      seamless payment options have saved me so much time and effort!
                      ”
                    </blockquote>
                ...
                >
                  <div className="testimonial rounded-4 p-4">
                    <blockquote className="mb-3">
                      “ As a freelancer, managing my finances can be overwhelming. The
                      budgeting tools and personalized insights have made it so much
                      easier to stay on top of my expenses and plan for the future. ”
                    </blockquote>
                    <div className="testimonial-author d-flex gap-3 align-items-center">
                      <div className="author-img">
                        <img
                ...
                >
                  <div className="testimonial rounded-4 p-4">
                    <blockquote className="mb-3">
                      “ The investment options and portfolio management tools on this
                      platform are top-notch. The variety of choices caters to all
                      types of investors, from conservative to aggressive. I
                      especially appreciate how the tailored recommendations align
                      perfectly with my financial goals. It’s a game-changer for
                      anyone serious about growing their wealth. ”
                    </blockquote>
                    <div className="testimonial-author d-flex gap-3 align-items-center">
                      <div className="author-img">
                        <img
                ...
                >
                  <div className="testimonial rounded-4 p-4">
                    <blockquote className="mb-3">
                      “ I never thought managing money could be this simple! The
                      user-friendly interface and secure transaction process give me
                      the confidence to handle my finances independently. ”
                    </blockquote>
                    <div className="testimonial-author d-flex gap-3 align-items-center">
                      <div className="author-img">
                        <img
                ...
                >
                  <div className="testimonial rounded-4 p-4">
                    <blockquote className="mb-3">
                      “ The security features are outstanding. Knowing that my
                      financial data is protected gives me peace of mind, and the
                      platform's efficiency makes it a pleasure to use. ”
                    </blockquote>
                    <div className="testimonial-author d-flex gap-3 align-items-center">
                      <div className="author-img">
                        <img
                ...
                >
                  <div className="testimonial rounded-4 p-4">
                    <blockquote className="mb-3">
                      “ The platform’s intuitive design and robust features have been
                      a game-changer for my startup. It’s helped me streamline
                      operations and focus on growing my business. ”
                    </blockquote>
                    <div className="testimonial-author d-flex gap-3 align-items-center">
                      <div className="author-img">
                        <img
                      ...
                      <div className="accordion-item">
                        ...
                        >
                          <div className="accordion-body">
                            ...
                            on the complexity, features, and specific requirements of
                            your project. We offer several pricing packages to
                            accommodate different budgets and needs. After an initial
                            consultation, we can provide a detailed quote based on
                      ...
                      <div className="accordion-item">
                        ...
                        >
                          <div className="accordion-body">
                            ...
                            depends on the project's complexity and scope. Typically,
                            a standard business website takes about 4-6 weeks to
                            complete, while more complex projects like e-commerce
                            sites or custom applications may take longer. We work
                            closely with our clients to establish a realistic timeline
                      ...
                      <div className="accordion-item">
                        ...
                        >
                          <div className="accordion-body">
                            ...
                            tablets, and smartphones. Ensuring a great user experience
                            on mobile devices is a top priority in our development
                            process.
                          </div>
                        </div>
                      </div>
                      <div className="accordion-item">
                        ...
                        >
                          <div className="accordion-body">
                            ...
                            functioning smoothly. Our maintenance packages can include
                            regular updates, security monitoring, backups, and
                            technical support to address any issues that may arise.
                            We're here to help you keep your website running
                            efficiently long after it's launched.
                          </div>
                        </div>
                      </div>
                    </div>
          ...
          */}
                  © Nova. All rights reserved. Designed with{" "}
